...
document.addEventListener("DOMContentLoaded", function() {
    ...
    changeInnerHTMLbyId("breadcrumbBar", '<ol class="jenkins-breadcrumbs__list" id="breadcrumbs"><li class="jenkins-breadcrumbs__list-item"><a href="/job/RTS/job/main/">R-PHY Lab Test Suite</a></li></ol>')
